<div class="grid grid-cols-3 h-16 bg-white items-center px-10 fixed z-50 w-full border-b-2 border-gray-200">
    ...
    <div class="col-span-1 flex flex-col items-center text-[#124d59]">
        <div class="text-xl">
            <i class="fa-regular fa-hourglass-half mr-2"></i><span class="font-semibold">00:00</span>
        </div>
