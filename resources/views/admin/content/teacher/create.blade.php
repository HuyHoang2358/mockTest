...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="-intro-x h-[45px] mr-auto">
        <ol class="breadcrumb breadcrumb-light">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.teacher.index')}}">Quản lý giáo viên</a></li>
                ...
                <div class="mt-5">
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="name" name="name" value="{{old('name')}}" type="text" class="form-control input-with-counter" placeholder="Nhập tên giáo viên" required autofocus>
                        ...
                        <div class="form-label xl:w-64 xl:!mr-10">
                            <div class="text-left">
                                ...
                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                    Mật khẩu của giáo viên mặc định là 123456789
                                </div>
                            </div>
                        </div>
