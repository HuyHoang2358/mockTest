...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="-intro-x h-[45px] mr-auto">
        <ol class="breadcrumb breadcrumb-light">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="#">Thông tin Giáo viên</a></li>
        </ol>
    </nav>
@endsection
...
@section('content')
            ...
            <div class="intro-y box mt-5">
                <div class="relative flex items-center p-5">
                    ...
                    <div class="ml-4 mr-auto">
                        ...
                        <div class="text-slate-500">Giáo viên</div>
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="pt-4 pb-1 px-5">
                    <div class="flex justify-between items-center">
                        ...
                        <form action="{{ route('admin.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa tài khoản không?')">
                            @csrf
                            @method('DELETE')
    ...
    @include('admin.components.select_avatar_admin')
