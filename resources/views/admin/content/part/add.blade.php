            ...
            <form action="{{route('admin.part.store', $exam->id)}}" method="POST">
                    ...
                    <div class="flex justify-end items-center gap-3">
                      ...
                      {{--  <!-- Tổng số điểm của phần -->
                        ...
                        <div class="flex justify-start items-center gap-1">
                            ...
                            <input id="part-1-total-time-input" name="part_total_time" type="number" min="0" max="720" class="w-20 form-control"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 mt-4 part-content">
                    <textarea type="text" class="form-control content-editor w-full text-sm" rows="3"
                              name="part_content" placeholder="Nhập nội dung phần thi"
                    ></textarea>
                </div>
...
@section('customJs')
    ...
    <script>
            ...
            return `
                  <div class="question-group-item mt-2 border-t-4 border-primary py-2" id="question-group-${questionGroupId}">
                        ...
                        <div class="mt-2 pl-5 relative w-full">
                            <input type="checkbox" class="form-check-input hidden" id="question-group-${questionGroupId}-answer-inside-content" name="question_groups[${questionGroupId}][answer_inside_content]" />
                            <textarea type="text" class="form-control content-editor" placeholder="Nhập nội dung nhóm câu hỏi"
        ...
        function addQuestion() {
            ...
            console.log("selectingQuestionGroupId", selectingQuestionGroupId)
        ...
        function handleExtractQuestions(questionGroupId) {
            ...
            const content = tinymce.get(`question-group-${questionGroupId}-content`).getContent({ format: 'text' });

            // checked to question-group-${questionGroupId}-answer-inside-content
            document.getElementById(`question-group-${questionGroupId}-answer-inside-content`).checked = true;
