                ...
                <div class="mt-5">
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="name" name="name" type="text" class="form-control input-with-counter"  value="{{ old('name', $user->name)}}" placeholder="Nhập tên học sinh" required autofocus>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input name="email" class="form-control p-3" value="{{ old('email', $user->email)}}" placeholder="Nhập địa chỉ email" required>
                        </div>
                    </div>
                </div>
